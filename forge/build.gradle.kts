...
loom {
    forge {
        ...
        mixinConfig(
            "hexagony-common.mixins.json",
            "hexagony-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexagony.apply-datagen-mixin", "true")
                property("hexagony.$platform-datagen", "true")
            }
        }
    }
}

hexagonyModDependencies {
