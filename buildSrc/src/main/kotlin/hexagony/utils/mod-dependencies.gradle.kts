...
abstract class HexagonyModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexagonyModDependenciesExtension>("hexagonyModDependencies")
