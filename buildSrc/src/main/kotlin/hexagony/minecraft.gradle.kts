...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexagony.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexagony-common-common-refmap.json
        // fixed:   hexagony-common.refmap.json
